<h2>ساخت پنل ادمین با Reactjs و Tailwindcss</h2>

این پروژه هنوز تکمیل نشده و در حال پیش رویه ☺️ <br/><br/>

```diff
- مرحله ای که الان در حال کار کردن هستم => طراحی و پیاده سازی صفحه داشبورد
```
...
<h2>دمو و طرح </h2>
<div align="right">
<a href="https://mohammad-admin-panel.netlify.app/">میتونی دمو رو تا اینجا ببینی</a>
<br/>
<br/>
